"""
sa_open_v4: Cross-attention KV cache + fused residual+layernorm + verification.
- Cross-attention KV caching from v3
- Triton fused residual_add_layernorm returns (norm, sum) to preserve residual for next add
"""
import gc
import os
import sys
...
print("Enabled sa_open_v4: cross-attention KV cache + fused residual-add + LayerNorm (Triton)")
